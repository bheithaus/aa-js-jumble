...
Game.prototype.valid = function(coords, mark) {
...
Game.prototype.placeMove = function(coords, mark) {
	if ( this.valid(coords, mark) ) {
		this.board[coords[0]][coords[1]] = mark;
	}
}
